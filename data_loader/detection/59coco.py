...
COCO_CLASS_LIST = [
    '__background__',
    'car', 'chair', 'book', 'bottle', 'cup',
    'dining table', 'traffic light', 'bowl', 'handbag', 'bird',
    'boat', 'truck', 'umbrella', 'bench', 'cow', 'banana',
    'motorcycle', 'carrot', 'backpack', 'sheep', 'potted plant',
    'wine glass', 'donut', 'kite', 'knife', 'bicycle', 'broccoli',
    'cake', 'suitcase', 'tv', 'orange', 'bus', 'pizza', 'remote',
    'vase', 'horse', 'surfboard', 'zebra', 'clock', 'sports ball',
    'cell phone', 'couch', 'elephant', 'tie', 'spoon', 'skis',
    'apple', 'giraffe', 'laptop', 'sink', 'tennis racket', 'dog',
    'fork', 'cat', 'teddy bear', 'train', 'skateboard', 'airplane',
    'sandwich'
]

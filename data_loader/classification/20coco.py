...
COCO_CLASS_LIST = ['person', 'car', 'chair', 'book', 'bottle', 'cup', 'dining table', 'bowl', 'traffic light', 'handbag', 'umbrella', 'bird', 'boat', 'truck', 'bench', 'sheep', 'banana', 'kite', 'motorcycle', 'backpack'] 

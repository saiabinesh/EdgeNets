...
#SBATCH -A ngcom020c
#SBATCH -p GpuQ
#SBATCH -o /ichec/work/ngcom020c/Sai/RQ3/logs/test_handsynth.txt
...
CUDA_VISIBLE_DEVICES=0 python test_detection.py --model espnetv2 --s 2.0 --dataset pascal --data-path ./vision_datasets/pascal_voc/VOCdevkit --im-size 512 --weights-test /ichec/work/ngcom020c/Sai/RQ3/EdgeNets/results_detection/model_espnetv2_handsynth/s_2.0_sch_hybrid_im_512/20211031-014717/espnetv2_2.0_checkpoint.pth.tar 
